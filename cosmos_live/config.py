...
class AgentConfig(BaseModel):
    ...
    instructions: str = (
        ...
        "- Time-bounded queries: \"what happened in the last 5 minutes (use the right number for this, in seconds, get time - 5 * 60)?\n"
        ...
        "- Searching for a specific event by meaning: \"was there ever a fire?\", \"was there ever a human in the feed?\"\n"
        ...
        "Only use `query` when the user is searching for something by its content/meaning or ask if there was something in the past but no time frame.\n\n"
        "### Time-based searches\n"
